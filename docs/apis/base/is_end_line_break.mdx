...
<p>
  <InlineIcon icon={mdiFunctionVariant} width='1.35rem' style={{"verticalAlign": "-0.3rem"}} /> Function
  <Splitter />
...
<p><Link to="https://docs.python.org/3/library/stdtypes.html#str.splitlines">
  <InlineIcon icon={octLinkExternal16} width='1.35rem' style={{"verticalAlign": "-0.3rem"}} /> https://docs.python.org/3/library/stdtypes.html#str.splitlines
</Link></p>
