...
<p>
  <DarkButton to="https://github.com/cainmagi/sync-stream/blob/main/LICENSE" icon={octLaw16}>
    MIT License
  </DarkButton>
</p>
...
<p>
  <DarkButton to="https://github.com/cainmagi/sync-stream/blob/main/CONTRIBUTING.md" icon={octRepoForked16}>
    Contributions
  </DarkButton>
</p>
...
<p>
  <DarkButton to="https://github.com/cainmagi/sync-stream/blob/main/CODE_OF_CONDUCT.md" icon={octShareAndroid16}>
    Code of Conduct
  </DarkButton>
</p>
