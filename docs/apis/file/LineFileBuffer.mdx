...
| :---------: | :---: | :-------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `file_path` | `str` | <InlineIcon icon={vsiCheckIcon}/> | The basic path of the saved records, including the saved storage and the file locks. The file suffix would be automatically set as `.log`.                                  |
