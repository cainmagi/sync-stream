...
| :---------: | :-----------: | :------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api_route` |     `str`     |          | The route path of the api. It has the same meaning of the parameter [`Api.add_resource(url)`<IconExternalLink/>][link-addresource].                                                                              |
| `endpoint`  | `str \| None` |          | The endpoint name of the api. If set `None`, the endpoint name would be inferred from `api_route`. It has the same meaning of the parameter [`Api.add_resource(endpoint)`<IconExternalLink/>][link-addresource]. |
...
| Argument |                           Type                            |             Required              | <center>Description</center>                                                                                       |
| :------: | :-------------------------------------------------------: | :-------------------------------: | :----------------------------------------------------------------------------------------------------------------- |
|  `api`   | [`flask_restful.Api`<IconExternalLink/>][link-restfulapi] | <InlineIcon icon={vsiCheckIcon}/> | The Flask `Api` object. All web services related to this `LineHostBuffer` would be registered to the `Api` object. |
