...
| Argument |                           Type                            | <center>Description</center>                                                                                       |
| :------: | :-------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------- |
|  `api`   | [`flask_restful.Api`<IconExternalLink/>][link-restfulapi] | The Flask `Api` object. All web services related to this `LineHostBuffer` would be registered to the `Api` object. |
