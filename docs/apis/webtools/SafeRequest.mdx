...
| :-------: | :--------------------: | :-------------------------------: | :---------------------------------------------------------------------------------------------------------------- |
| `request` | `urllib3.HTTPResponse` | <InlineIcon icon={vsiCheckIcon}/> | The reqeust to be wrapped. This wrapped request will be disconnected and released when exiting from this context. |
