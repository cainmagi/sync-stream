          ...
          text={
            hasText
              ? text ||
                translate(
                  {
                    id: "components.apitopbar.icon.obj",
                    description:
                      "The text displayed for the APITopBar icon: Instance.",
                    message: "Instance",
                  },
                  {}
                )
          ...
          text={
            hasText
              ? text ||
                translate(
                  {
                    id: "components.apitopbar.icon.desc",
                    description:
                      "The text displayed for the APITopBar icon: Descriptor.",
                    message: "Descriptor",
                  },
                  {}
                )
          ...
          text={
            hasText
              ? text ||
                translate(
                  {
                    id: "components.apitopbar.icon.exc",
                    description:
                      "The text displayed for the APITopBar icon: Exception.",
                    message: "Exception",
                  },
                  {}
                )
...
export type APITopBarProps = {
  type: "class" | "func" | "module" | "type" | "obj";
  isPrivate?: boolean;
  isAbstract?: boolean;
  isContext?: boolean;
  isDecorator?: boolean;
  ...
  return (
    <p>
      ...
      {props.isDescriptor && (
        <>
          <Splitter />
          <IconObjType type={"desc"} hasText={true} />
        </>
      )}
      {props.isException && (
        <>
          <Splitter />
          <IconObjType type={"exc"} hasText={true} />
        </>
      )}
      {props.isMixin && (
        <>
