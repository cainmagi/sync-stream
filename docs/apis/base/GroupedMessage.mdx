...
| :------: | :--------------: | :------------------------------------------------------------------------------------------------------------------------------------------ |
| `jdata`  | `dict[str, Any]` | The serialized dictionary. This dictionary could be converted back to `GroupedMessage` object by the [`deserialize`](#-deserialize) method. |
...
| Argument |       Type       |             Required              | <center>Description</center>                                                                                 |
| :------: | :--------------: | :-------------------------------: | :----------------------------------------------------------------------------------------------------------- |
| `jdata`  | `dict[str, Any]` | <InlineIcon icon={vsiCheckIcon}/> | The serialized dictionary. This dictionary is JSON compatible, and could be transmitted by the web packages. |
