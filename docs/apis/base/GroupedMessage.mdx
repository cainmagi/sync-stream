...
| :------: | :--------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------ |
| `jdata`  | [`SerializedMessage`](./SerializedMessage.mdx) | The serialized dictionary. This dictionary could be converted back to `GroupedMessage` object by the [`deserialize`](#-deserialize) method. |
...
| Argument |                 Type                  |             Required              | <center>Description</center>                                                                                                                                        |
| :------: | :-----------------------------------: | :-------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `jdata`  | `SerializedMessage \| GroupedMessage` | <InlineIcon icon={vsiCheckIcon}/> | The serialized dictionary. This dictionary is JSON compatible, and could be transmitted by the web packages. If it is not a serialized dictionary, return as it is. |
